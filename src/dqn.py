...
class DQN:
    ...
    def train(self, game_batch_data, epoch_factor, graph, graph_input, graph_action_value, graph_updated_value):
        ...
        for x in no_of_epochs:
            ...
            self.sess.run(graph, feed_dict={graph_input: np.array(input_observation),
