...
class Player:
    ...
    def play(self):
        ...
        for x in range(self.no_of_steps):
            ...
            self.dqn.train(batch_data_store, 50, self.graph, self.graph_input, self.graph_action_value,
                           self.graph_updated_action,self.tf_merged_summary_op,self.tf_writer)
